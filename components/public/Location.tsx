  ...
  return (
    <section className="relative bg-background py-24" id="ubicacion">
      <div className="container mx-auto grid items-center gap-8 px-6 md:grid-cols-2 md:px-12">
        ...
        <div className="relative h-[500px] w-full overflow-hidden rounded-xl border-4 border-background bg-muted shadow-2xl">
          {/* TODO: look  */}
          <iframe
            ...
            loading="lazy"
          ></iframe>
          <div className="absolute top-1/2 left-1/2 flex h-24 w-24 -translate-x-12 -translate-y-12 animate-pulse items-center justify-center rounded-full bg-primary/20">
